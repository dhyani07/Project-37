...
function setup() {
  ...
  restart = createSprite(displayWidth/2,displayHeight/3+40);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(600,displayHeight-320,40,10);
    cloud.y = Math.round(random(displayHeight-380,displayHeight-420));
